...
var story = storiesOf('Molecules|Carousel', module);
var images = [
    {
        alt: 'Slide 1',
...
story.add('No Indicator', withInfo({})(function () { return ({
    data: function () {
        return {
            images: images,
        };
...
story.add('Fast Slider', withInfo({})(function () { return ({
    data: function () {
        return {
            images: images,
        };
...
//# sourceMappingURL=VueCarousel.stories.js.map