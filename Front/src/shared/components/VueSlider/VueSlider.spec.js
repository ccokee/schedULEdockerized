...
describe('VueSlider.vue', function () {
    test('renders component with multiple handles', function () {
        window.addEventListener = jest.fn();
        window.removeEventListener = jest.fn();
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
                max: 100,
    ...
    test('renders component with single handles', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('renders disable slider', function () {
    ...
    test('should add handlers on moveStart', function () {
        document.addEventListener = jest.fn();
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
    ...
    test('should remove handlers on moveEnd', function () {
    ...
    test('should do nothing on moveEnd if currentSlider is null', function () {
        document.removeEventListener = jest.fn();
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
    ...
    test('should add active class to handle', function () {
        document.removeEventListener = jest.fn();
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
    ...
    test('should move left handle with multi handles', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should move right handle', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should return closest handle with multi range', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should return closest handle with single range', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should handle key events on left handle', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should handle key events on right handle', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should handle key events on left handle with single range', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
    ...
    test('should  emit on key up', function () {
        var wrapper = mount(VueSlider, {
            localVue: localVue,
            propsData: {
                min: 0,
...
//# sourceMappingURL=VueSlider.spec.js.map